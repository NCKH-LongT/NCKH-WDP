...
Đây là một trong những bài báo có mức độ liên quan miền cao nhất đối với pipeline backend của nhóm. Đề xuất của nhóm cũng bao gồm telemetry dạng dòng và cơ chế chấm điểm bất thường trong trung tâm dữ liệu mô phỏng, và công trình này cung cấp một tham chiếu cụ thể cho phát hiện bất thường hạ tầng trực tuyến trong điều kiện không dừng.

## Hướng cải tiến khả dĩ

Trong dự án của nhóm, có thể kết hợp loại logic thích nghi trực tuyến này với telemetry dựa trên metric thay vì chỉ dựa vào log. Nhóm cũng có thể so sánh một đường cơ sở tiến hóa gọn nhẹ với Isolation Forest hoặc các mô hình chuỗi để biện minh rõ hơn cho không gian thiết kế AI trong đề xuất.
