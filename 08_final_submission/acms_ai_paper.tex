...
Krithika, D.R. et al.: Smart event management system using machine learning for optimized scheduling and participant behavior tracking. In: Proceedings of the 2025 International Conference on Computational Robotics, Testing and Engineering Evaluation (ICCRTEE). IEEE (2025). \url{https://ieeexplore.ieee.org/document/11052976}

\bibitem{ref_aduvia}
Costagliola, G., De Rosa, M., Fuccella, V., Piscitelli, A., Tabari, P.: Quiz generation and chat interaction with LLMs: A design and implementation of an AI-based LMS. In: Proceedings of the 2025 International Conference on Software, Telecommunications and Computer Networks (SoftCOM), pp. 1--6. IEEE (2025). \doi{10.23919/SoftCOM66362.2025.11197405}

\bibitem{ref_advising_llm}
Lekan, K., Pardos, Z.A.: AI-augmented advising: A comparative study of GPT-4 and advisor-based major recommendations. Journal of Learning Analytics \textbf{12}(1), 110--128 (2025). \doi{10.18608/jla.2025.8593}

\bibitem{ref_augmented_advising}
Jiang, W., Wang, S., Eltigani, H., Haroon, R., Bin Faisal, A., Dogar, F.: AdvisingWise: Supporting academic advising in higher education settings through a human-in-the-loop multi-agent framework. arXiv preprint arXiv:2511.05706 (2025). \url{https://arxiv.org/abs/2511.05706}

\bibitem{ref_quiz_gen}
Ali, F.I., Ali, T.E., Aljamal, W., Daki\'c, P., Zolt\'an, A.D.: AI-powered quiz generation for learning management systems: A full-stack implementation for Canvas LMS. In: CEUR Workshop Proceedings, vol. 4076, Third Workshop on Co-Creating New Ways of Information Systems Education (NWISEd 2025), pp. 1--10 (2025). \url{https://ceur-ws.org/Vol-4076/short3.pdf}

\bibitem{ref_supervisor1}
Bakar, Z.A. et al.: Research supervisor recommendation system based on topic conformity. International Journal of Modern Education and Computer Science \textbf{12}(1), 23--31 (2020). \doi{10.5815/ijmecs.2020.01.04}

\bibitem{ref_supervisor2}
Nguyen, T. et al.: A TF-IDF-LDA approach for training recommender system based on faculty interests. In: Proceedings of the 2025 6th Asia Service Sciences and Software Engineering Conference (SSASE), pp. 42--48. ACM (2025). \doi{10.1145/3775030.3775036}
