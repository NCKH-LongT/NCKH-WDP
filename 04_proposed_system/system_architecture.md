...
The system follows a MERN-based architecture with React Admin/Judge Web, React Native Mobile App, Node.js/Express backend, MongoDB database, GitHub API/Webhook integration and an external AI model API.
...
Node.js / Express Backend
        ...
        |
        v
External Services: GitHub API, AI model API, Email Provider
```
...
| AI Evaluation Service | Build structured rubric prompt, call AI model, parse JSON, save AIReview and AIReviewCriteria |
